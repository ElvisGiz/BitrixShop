				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Подписаться на<strong>РАССЫЛКУ</strong></p>
							<form>
								<input class="input" type="email" placeholder="Введите свою почту">
						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									...
									<li><a href="#"><i class="fa fa-phone"></i>+7 962 537 86 86</a></li>
